...
add_action( 'genesis_after', 'bw_footer' );
	function bw_footer() { ?><div id="footer"><div class="wrap">
...
def show
  puts "Outputting a very long line"
...
<div markdown="1" class="notice-danger">**Warning Danger:** `.notice-danger` Maecenas ornare tortor. [Donec sed tellus]() eget sapien fringilla nonummy. Mauris a ante. Suspendisse quam sem, consequat at.</div>
